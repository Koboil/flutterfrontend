...
class FairgroundManagementHomePage extends StatefulWidget {
  const FairgroundManagementHomePage({Key? key}) : super(key: key);

  @override
  _FairgroundManagementHomePageState createState() =>
      _FairgroundManagementHomePageState();
}

class _FairgroundManagementHomePageState
    extends State<FairgroundManagementHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Fairground Management'),
      ),
